...
static auto create_debug_utils_messenger_ext(VkInstance instance, const VkDebugUtilsMessengerCreateInfoEXT* pCreateInfo, const VkAllocationCallbacks* pAllocator, VkDebugUtilsMessengerEXT* pDebugMessenger) -> VkResult {
...
VKAPI_ATTR auto VKAPI_CALL SimpleBasicApplication::debug_callback(VkDebugUtilsMessageSeverityFlagBitsEXT message_severity, 
    ...
    std::cerr << "::VK " << severity_str << "::  " << DebugIndent << type_str << "; " << "validation layer: " << p_callback_data->pMessage << "\n";
...
void SimpleBasicApplication::populate_debug_messenger_create_info(VkDebugUtilsMessengerCreateInfoEXT& create_info) {
    create_info = {};
