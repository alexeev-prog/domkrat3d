...
class ProjectPackager:
    ...
    def _load_config(self, config_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise PackagingError(f"Invalid config file: {str(e)}")
    ...
    def _is_excluded(self, path: Path) -> bool:
        ...
        return any(
            part in self.config.get('exclude_dirs', [])
...
def main():
    ...
    parser.add_argument('-c', '--config', default='packager.json',
    ...
    try:
        ...
        logging.error("Packaging failed: %s", str(e))
        exit(1)
